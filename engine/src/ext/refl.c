...
refl_type gool_process_type = {
  ...
  .flags = REFL_FLAGS_STATIC,
  .fields = {
    REFL_FIELD(gool_process,gool_object*,gool_links.self),
    REFL_FIELD(gool_process,gool_object*,gool_links.parent),
    REFL_FIELD(gool_process,gool_object*,gool_links.sibling),
    REFL_FIELD(gool_process,gool_object*,gool_links.children),
    REFL_FIELD(gool_process,gool_object*,gool_links.creator),
    REFL_FIELD(gool_process,gool_object*,gool_links.player),
    REFL_FIELD(gool_process,gool_object*,gool_links.collider),
    REFL_FIELD(gool_process,gool_object*,gool_links.interrupter),
